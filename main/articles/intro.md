...
`#> `\
`#>     table`\
[`head`](https://rdrr.io/r/utils/head.html)`(``glm_data``)`\
...
\
[`robin_lm`](https://openpharma.github.io/RobinCar2/reference/robin_lm.md)`(``y`` ``~`` ``treatment`` ``*`` ``s1`` ``+`` ``covar``,`\
`  data ``=`` ``glm_data``,`\
...
\
[`robin_glm`](https://openpharma.github.io/RobinCar2/reference/robin_glm.md)`(``y_b`` ``~`` ``treatment`` ``*`` ``s1`` ``+`` ``covar``,`\
`  data ``=`` ``glm_data``,`\
`  treatment ``=`` ``treatment`` ``~`` ``pb``(``s1``)``,`\
...
\
`glm_data``$``y_count`` ``<-`` `[`rpois`](https://rdrr.io/r/stats/Poisson.html)`(`[`nrow`](https://rdrr.io/r/base/nrow.html)`(``glm_data``)``, lambda ``=`` ``20``)`\
[`robin_glm`](https://openpharma.github.io/RobinCar2/reference/robin_glm.md)`(`\
`  ``y_count`` ``~`` ``treatment`` ``*`` ``s1`` ``+`` ``covar``,`\
`  data ``=`` ``glm_data``,`\
`  treatment ``=`` ``treatment`` ``~`` ``pb``(``s1``)``,`\
`  family ``=`` ``MASS``::`[`negative.binomial`](https://rdrr.io/pkg/MASS/man/negative.binomial.html)`(``theta ``=`` ``1``)`\
`)`\
...
\
`robin_res`` ``<-`` `[`robin_glm`](https://openpharma.github.io/RobinCar2/reference/robin_glm.md)`(``y_b`` ``~`` ``treatment`` ``*`` ``s1`` ``+`` ``covar``,`\
`  data ``=`` ``glm_data``,`\
`  treatment ``=`` ``treatment`` ``~`` ``ps``(``s1``)``,`\
`  family ``=`` `[`binomial`](https://rdrr.io/r/stats/family.html)`(``link ``=`` ``"logit"``)``,`\
...
\
[`confint`](https://openpharma.github.io/RobinCar2/reference/confint.md)`(``robin_res``$``marginal_mean``, parm ``=`` ``1``:``2``, level ``=`` ``0.7``)`\
`#>       Estimate      15 %      85 %`\
`#> pbo  0.3560965 0.3212733 0.3909198`\
`#> trt1 0.5806957 0.5450238 0.6163677`\
[`confint`](https://openpharma.github.io/RobinCar2/reference/confint.md)`(``robin_res``$``marginal_mean``, level ``=`` ``0.7``)`\
`#>       Estimate      15 %      85 %`\
`#> pbo  0.3560965 0.3212733 0.3909198`\
`#> trt1 0.5806957 0.5450238 0.6163677`\
...
\
[`confint`](https://openpharma.github.io/RobinCar2/reference/confint.md)`(``robin_res``$``contrast``)`\
...
[`confint`](https://openpharma.github.io/RobinCar2/reference/confint.md)`(``robin_res``$``contrast``, transform ``=`` ``identity``)`\
`#>                  Estimate      2.5 %    97.5 %`\
