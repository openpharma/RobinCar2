...
```{r}
robin_surv <- function(formula, data, treatment, contrast = "hazardratio", pval = "logrank", ...) {
    ...
    # Return results as a list with class 'surv_effect'
    result <- list(
        estimates = data.frame(
            Estimate = c(0.56365, 0.77093, 0.20728),
            Std.Err = c(0.10074, 0.10133, 0.10683),
            Z.Value = c(5.5952, 7.6082, 1.9402),
            Pr.z = c(2.203e-08, 0.05235, 2.779e-14)
        )
    )
