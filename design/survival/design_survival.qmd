...
We can compare this with the earlier calculated unadjusted hazard ratio estimate:
...
We can compare that with the earlier calculated unadjusted standard error:

```{r}
our_theta_est_se
```

So interestingly, this is slightly larger here than the unadjusted one. 
Let's see later if this actually is correct...
