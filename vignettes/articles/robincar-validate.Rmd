---
title: "RobinCar Validation"
output: rmarkdown::html_document
vignette: >
  %\VignetteIndexEntry{RobinCar Validation}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

This document validate RobinCar2 against RobinCar.
...
The response is following normal distribution.
...
test_that("contrast -- standard options", {
  ...
  for (scheme in c("simple", "pocock-simon", "permuted-block")) {
    ...
    r2_odds <- run_robin2(contrast = \(x, y) (x / (1 - x)) / (y / (1 - y)))
